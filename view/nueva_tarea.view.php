...
<div class="banner">
	...
	<form class="form-new" action="" method="POST" enctype="multipart/form-data">
		<h2 class="form-new-title">Nueva tarea</h2>
		<label for="title">Titulo:</label><br>
		<input type="text" name="title" placeholder="Escribe el titulo..."><br>
		...
		<textarea name="commenter" placeholder="Escribe un mensaje..."></textarea><br>
		
		<label for="link">Link de YouTube:</label><br>
		<input type="text" name="link" placeholder="Pega aqui la URL de un video de YouTube..."><br>
		...
		<select name="grupo">
			...
			for ($i=0; $i < count($grupo) ; $i++) { 
				echo "<option>".$grupo[$i]."</option>";
			}
			?>
		</select><br>

		<input type="submit" name="btn-add" value="Agregar">
